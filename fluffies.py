...
music_genres = ["rap", "classical", "bitpop", "industrial", "ebm", "hiphop", "jazz", "electronic", "ambient", "80s", "reggae", "rock", "country", "techno", "gospel", "black metal", "alternative rock", "ska", "new wave", "punk", "dubstep", "hardstyle"]
tv_series = ["Breaking Bad", "Sons of Anarchy", "The Witcher", "Game of Thrones", "Teenage Mutant Ninja Turtles", "Black Mirror"]
